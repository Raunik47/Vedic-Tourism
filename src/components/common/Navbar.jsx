...
function NavLinks({ className = "", itemClass = "", onClick }) {
...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white/80 backdrop-blur-md shadow-lg fixed w-full top-0 z-50 border-b border-orange-100">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between h-20 items-center">
                ...
                <div className="hidden md:flex items-center space-x-8">
                  <NavLinks className="flex items-center space-x-6" itemClass="px-3 py-2 text-sm font-medium transition-all duration-300" />
                  <motion.button
            ...
            {/* Mobile single nav (scrollable) - only one menu on mobile */}
            <div className="md:hidden px-3 pb-2 bg-white/90 backdrop-blur-md border-t border-orange-100">
              <NavLinks
                className="flex items-center gap-3 overflow-x-auto no-scrollbar px-2 py-2"
                itemClass="whitespace-nowrap text-sm font-medium px-2 py-2"
              />
            </div>
          </nav>
        );
